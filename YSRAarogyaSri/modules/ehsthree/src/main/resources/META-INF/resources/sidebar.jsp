	...
	<div class="d-flex flex-column flex-shrink-0 sidebar_menu" id="accordionFlushExample">
						...
						<i class="fa-sharp fa-solid fa-user-tie"></i> &nbsp;For Employees/ Pensioners
...
<li class="mb-1">
								...
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									...
									<!-- <li><a href="https://www.ehs.ap.gov.in/OperationsAP/individualMedicalReport.jsp" target="_blank">Pensioners Medical Reimbursement Status</a></li> -->                                  
								</ul></div>
							</li> 
<li class="mb-1">
...
<li class="mb-1">
							...
							<li class="mb-1">
								...
								<div class="collapse <% if(pageId==585 || pageId==587 || pageId==595){ %> show <% } %>" id="employees-collapse" data-bs-parent="#citizen-collapse">
								<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
									<li><a href="/web/guest/ehs-v4">Search by Geography</a></li>
									
									<li><a href="/web/guest/ehsspeciality">Search by Speciality</a></li>
						...
						<div class="collapse <% if(pageId==105 || pageId==97 ){ %> show <% } %> " id="usman-collapse1" data-bs-parent="#hospital-collapse">
						  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
			...
			<div class="collapse  <% if(pageId==541 || pageId==190){ %> show <% } %> " id="hospital-collapse1" data-bs-parent="#hospital-collapse">
			<ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
