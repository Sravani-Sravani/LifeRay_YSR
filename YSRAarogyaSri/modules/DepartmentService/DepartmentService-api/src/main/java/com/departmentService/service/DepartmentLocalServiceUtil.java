 ...
 * <code>com.departmentService.service.impl.DepartmentLocalServiceImpl</code> and
...
public class DepartmentLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.departmentService.service.impl.DepartmentLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Department createDepartment(long did) {
		return getService().createDepartment(did);
	}
	 ...
	 */
	public static Department deleteDepartment(long did) throws PortalException {
		return getService().deleteDepartment(did);
	}
	...
	public static Department fetchDepartment(long did) {
		return getService().fetchDepartment(did);
	}
	 ...
	 * @throws PortalException if a department with the primary key could not be found
	 */
	public static Department getDepartment(long did) throws PortalException {
		return getService().getDepartment(did);
	}
