...
public interface DepartmentLocalService
	...
	public Department createDepartment(long did);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Department deleteDepartment(long did) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department fetchDepartment(long did);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Department getDepartment(long did) throws PortalException;
