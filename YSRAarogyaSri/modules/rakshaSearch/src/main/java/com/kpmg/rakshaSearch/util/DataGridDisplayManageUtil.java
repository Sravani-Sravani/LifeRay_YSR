...
public static org.json.JSONArray getrakshastatelist() {
	org.json.JSONObject myObject =null;
	org.json.JSONArray array = null;
	try {
		 //final String POST_PARAMS = "{\n" + "\"specialityId\": "+ "\n}";
		    //System.out.println(POST_PARAMS);
		   URL obj = new URL("http://10.48.19.62:8092/portalsearchapi/public/AR-statelist");
	       HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
		   postConnection.setRequestMethod("GET");
		   postConnection.setRequestProperty("Content-Type", "application/json;odata=verbose");
		    postConnection.setRequestProperty("Accept", "application/json;odata=verbose");
		    ...
		    if (responseCode == 200 || responseCode == HttpURLConnection.HTTP_CREATED) { //success
		       ...
		       //  System.out.println("myObject"+myObject.getString("result"));
		        ...
		        System.out.println("rakshastateList get is not working");
		       }
	} catch (Exception e) {
		e.printStackTrace();
	}
...
public static org.json.JSONArray getrakshadistrictlist(String stateId) {
	org.json.JSONObject myObject =null;
	org.json.JSONArray array = null;
	try {
		 final String POST_PARAMS = "{\n" + "\"stateId\": "+stateId+ "\n}";
		    System.out.println(POST_PARAMS);
		   URL obj = new URL("http://10.48.19.62:8092/portalsearchapi/public/AR-districtlist");
	       HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
		   postConnection.setRequestMethod("POST");
		   postConnection.setRequestProperty("Content-Type", "application/json;odata=verbose");
		    postConnection.setRequestProperty("Accept", "application/json;odata=verbose");
...
public static org.json.JSONArray getrakshamandallist(String districtId) {
	org.json.JSONObject myObject =null;
	org.json.JSONArray array = null;
	try {
		 final String POST_PARAMS = "{\n" + "\"districtId\": "+districtId+ "\n}";
		    System.out.println(POST_PARAMS);
		   URL obj = new URL("http://10.48.19.62:8092/portalsearchapi/public/AR-mandallist");
	       HttpURLConnection postConnection = (HttpURLConnection) obj.openConnection();
		   postConnection.setRequestMethod("POST");
		   postConnection.setRequestProperty("Content-Type", "application/json;odata=verbose");
		    postConnection.setRequestProperty("Accept", "application/json;odata=verbose");
		    ...
		    if (responseCode == 200 || responseCode == HttpURLConnection.HTTP_CREATED) { //success
		        ...
		        System.out.println("POST NOT WORKED in raksha mandal list");
		       }
	} catch (Exception e) {
		e.printStackTrace();
	}
