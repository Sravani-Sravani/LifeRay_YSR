        ...
        tables:[
            {
                ...
                columns:["Code","Speciality Name","Treatment Code","Treatment Name","Mandatory Investigation","Packages","Post Operative/Treatment Investigation"],
                options:{},
                scrollX: false,
                header: true,
                footer: true
...
//}); 
  ...
  <div class="col-md-4"></div>
	  ...
	  <div class="container search_panel">
		  <h3>Arogya Raksha / Treatment Search</h3>
 ...
 <div class="col-2"  style="padding-top: 22px;">
	<h6>Treatment Search</h6>		 
				...
				<select class="form-select" id="select-2" label="Procedure Code" name="select-2">
				    <option value="">Show All</option>
				 </select>
				</div>   -->
