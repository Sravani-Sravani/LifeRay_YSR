...
/**
 * Provides the local service utility for Wing. This utility wraps
 * <code>com.keyPeopleService.service.impl.WingLocalServiceImpl</code> and
 ...
 * @generated
 */
public class WingLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.keyPeopleService.service.impl.WingLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Wing addWing(Wing wing) {
		return getService().addWing(wing);
	}
	 ...
	 * @return the new wing
	 */
	public static Wing createWing(long wid) {
		return getService().createWing(wid);
	}
	 ...
	 */
	public static Wing deleteWing(long wid) throws PortalException {
		return getService().deleteWing(wid);
	}
	 ...
	 * @return the wing that was removed
	 */
	public static Wing deleteWing(Wing wing) {
		return getService().deleteWing(wing);
	}
	...
	public static Wing fetchWing(long wid) {
		return getService().fetchWing(wid);
	}
	 ...
	 * @throws PortalException if a wing with the primary key could not be found
	 */
	public static Wing getWing(long wid) throws PortalException {
		return getService().getWing(wid);
	}
	 ...
	 */
	public static List<Wing> getWings(int start, int end) {
		return getService().getWings(start, end);
	}
	 ...
	 */
	public static int getWingsCount() {
		return getService().getWingsCount();
	}
	 ...
	 */
	public static Wing updateWing(Wing wing) {
		return getService().updateWing(wing);
	}

	public static WingLocalService getService() {
		return _service;
	}

	private static volatile WingLocalService _service;
