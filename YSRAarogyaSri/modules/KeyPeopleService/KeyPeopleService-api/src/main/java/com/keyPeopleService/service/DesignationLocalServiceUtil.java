 ...
 * <code>com.keyPeopleService.service.impl.DesignationLocalServiceImpl</code> and
...
public class DesignationLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.keyPeopleService.service.impl.DesignationLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Designation createDesignation(long did) {
		return getService().createDesignation(did);
	}
	 ...
	 */
	public static Designation deleteDesignation(long did)
		throws PortalException {

		return getService().deleteDesignation(did);
	}
	...
	public static Designation fetchDesignation(long did) {
		return getService().fetchDesignation(did);
	}
	 ...
	 * @throws PortalException if a designation with the primary key could not be found
	 */
	public static Designation getDesignation(long did) throws PortalException {
		return getService().getDesignation(did);
	}
