...
public interface DesignationLocalService
	...
	public Designation createDesignation(long did);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Designation deleteDesignation(long did) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Designation fetchDesignation(long did);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Designation getDesignation(long did) throws PortalException;
