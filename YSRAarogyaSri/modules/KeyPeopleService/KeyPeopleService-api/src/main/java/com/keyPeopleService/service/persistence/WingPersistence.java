...
/**
 * The persistence interface for the wing service.
 *
 * <p>
 ...
 */
@ProviderType
public interface WingPersistence extends BasePersistence<Wing> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WingUtil} to access the wing persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<Wing> wings);
	 ...
	 * @return the wings
	 */
	public java.util.List<Wing> findAll();
	 ...
	 */
	public java.util.List<Wing> findAll(int start, int end);
	...
	public java.util.List<Wing> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<Wing>
			orderByComparator);
