...
/**
 * The base model implementation for the KeyPeople service. Represents a row in the &quot;apgovt_keyPeople&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class KeyPeopleModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "apgovt_keyPeople";
	...
	public static final String TABLE_SQL_CREATE =
		"create table apgovt_keyPeople (trust_userId LONG not null primary key,empname VARCHAR(75) null,phone VARCHAR(75) null,email VARCHAR(75) null,wingId LONG,designationId LONG,status VARCHAR(75) null,empOrder VARCHAR(75) null,createDate DATE null,createdBy VARCHAR(75) null,modifyDate DATE null,modifyBy VARCHAR(75) null)";

	public static final String TABLE_SQL_DROP = "drop table apgovt_keyPeople";

	public static final String ORDER_BY_JPQL =
		" ORDER BY keyPeople.empOrder ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY apgovt_keyPeople.empOrder ASC";
