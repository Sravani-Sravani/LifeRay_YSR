 ...
 * <code>com.kpmg.sample.service.impl.sampleLocalServiceImpl</code> and
...
public class sampleLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.kpmg.sample.service.impl.sampleLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static sample addsample(sample sample) {
	...
	public static sample createsample(long id) {
		return getService().createsample(id);
	}
	 ...
	 */
	public static sample deletesample(long id) throws PortalException {
		return getService().deletesample(id);
	}
	 ...
	 * @return the sample that was removed
	 */
	public static sample deletesample(sample sample) {
	...
	public static sample fetchsample(long id) {
		return getService().fetchsample(id);
	}
	 ...
	 * @throws PortalException if a sample with the primary key could not be found
	 */
	public static sample getsample(long id) throws PortalException {
		return getService().getsample(id);
	}
	 ...
	 */
	public static List<sample> getsamples(int start, int end) {
	 ...
	 */
	public static sample updatesample(sample sample) {
	...
	private static volatile sampleLocalService _service;
