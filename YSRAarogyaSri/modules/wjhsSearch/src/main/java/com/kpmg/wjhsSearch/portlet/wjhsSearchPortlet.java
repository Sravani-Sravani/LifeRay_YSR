package com.kpmg.wjhsSearch.portlet;

import com.kpmg.wjhsSearch.constants.AsrimSearchPortletKeys;
...
@Component(
	...
	property = {
		...
		"javax.portlet.name=" + AsrimSearchPortletKeys.WJHSSEARCH,
		"javax.portlet.resource-bundle=content.Language",
		"javax.portlet.security-role-ref=power-user,user"
	},
	service = Portlet.class
)
public class wjhsSearchPortlet extends MVCPortlet {
	Log _log=LogFactoryUtil.getLog(wjhsSearchPortlet.class.getName());
	@Override
