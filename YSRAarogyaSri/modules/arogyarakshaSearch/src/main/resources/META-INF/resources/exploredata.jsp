 ...
 <h3 class="bordertitle text-dark">Explore Data</h3>
  <div class="accordion" id="accordionExample-1">
    ...
    <table class="table table-bordered">
      ...
      <tbody>
       <tr>
      <td><a href="https://app.ysraarogyasri.ap.gov.in/ASRI/common/Districts.jsp?stateFlag=ap" target="_blank" style="text-decoration: none"> Data Tables District Wise Details of Dr. YSR Aarogyasri </a></td>
  ...
  <div class="accordion-body">
    <table class="table table-bordered">
    <thead>
     <tr style="background-color: #7bbf4b;">
      <th scope="col" colspan="2" style="text-align: center; background-color: #7bbf4b; color: white;" class="table table-bordered "> Data Visualisations </th>
     </tr>
     <tr>
      <td><a href="https://app.ysraarogyasri.ap.gov.in/ASRI/reportsAction.do?actionFlag=hospDistPer&amp;stateFlag=ap" target="_blank" style="text-decoration: none"> District wise hospital performance</a></td>
      <td><a href="https://app.ysraarogyasri.ap.gov.in/ASRI/reportsAction.do?actionFlag=hospDistCatPer&amp;stateFlag=ap" target="_blank" style="text-decoration: none">Hospital wise performance of categories</a></td>
     </tr>
     <tr>
      <td><a href="https://app.ysraarogyasri.ap.gov.in/ASRI/reportsAction.do?actionFlag=PatDistrictCatPerf&amp;stateFlag=ap" target="_blank" style="text-decoration: none">Patient District wise performance of categories</a></td>
      <td></td>
     </tr>
    </thead>
     </table>
  ...
  <table class="table table-sm table-bordered table-hover">
    <thead style="background-color: #7bbf4b;">
     <tr>
    <th scope="col" colspan="2" style="text-align: center; background-color: #7bbf4b; color: white;" class="table table-bordered"> Vital Statistics </th>
     </tr>
    </thead>
    <tbody>
     <tr>
    <td>
     <table class="table table-bordered">
      <thead style="background-color: #1b65a6; color: white;">
       <tr>
  ...
  Vital statistics before 2nd June,2014
  </button>
  </h4>
  ...
  <thead style="background-color:#1b65a6; color:white">
   <tr>
    <th scope="col" colspan="2" style="text-align: center; background-color: #7bbf4b; color: white;"> Vital statistics before 2nd June, 2014 </th>
   </tr>
  </thead>
  <tbody>
   <tr>
