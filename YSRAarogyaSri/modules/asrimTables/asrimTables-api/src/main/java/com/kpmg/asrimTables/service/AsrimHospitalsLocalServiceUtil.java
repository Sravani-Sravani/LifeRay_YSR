...
/**
 * Provides the local service utility for AsrimHospitals. This utility wraps
 * <code>com.kpmg.asrimTables.service.impl.AsrimHospitalsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class AsrimHospitalsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.kpmg.asrimTables.service.impl.AsrimHospitalsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static AsrimHospitals addAsrimHospitals(
		AsrimHospitals asrimHospitals) {

		return getService().addAsrimHospitals(asrimHospitals);
	}
	 ...
	 */
	public static AsrimHospitals createAsrimHospitals(String HOSP_ID) {
		return getService().createAsrimHospitals(HOSP_ID);
	}
	 ...
	 */
	public static AsrimHospitals deleteAsrimHospitals(
		AsrimHospitals asrimHospitals) {

		return getService().deleteAsrimHospitals(asrimHospitals);
	}
	 ...
	 */
	public static AsrimHospitals deleteAsrimHospitals(String HOSP_ID)
		throws PortalException {

		return getService().deleteAsrimHospitals(HOSP_ID);
	}
	...
	public static AsrimHospitals fetchAsrimHospitals(String HOSP_ID) {
		return getService().fetchAsrimHospitals(HOSP_ID);
	}
	 ...
	 * @throws PortalException if a asrim hospitals with the primary key could not be found
	 */
	public static AsrimHospitals getAsrimHospitals(String HOSP_ID)
		throws PortalException {

		return getService().getAsrimHospitals(HOSP_ID);
	}
	 ...
	 */
	public static List<AsrimHospitals> getAsrimHospitalses(int start, int end) {
		return getService().getAsrimHospitalses(start, end);
	}
	 ...
	 */
	public static int getAsrimHospitalsesCount() {
	 ...
	 */
	public static AsrimHospitals updateAsrimHospitals(
		AsrimHospitals asrimHospitals) {

		return getService().updateAsrimHospitals(asrimHospitals);
	}

	public static AsrimHospitalsLocalService getService() {
		return _service;
	}

	private static volatile AsrimHospitalsLocalService _service;
