...
/**
 * The persistence interface for the asrim hospitals service.
 *
 * <p>
 ...
 * @see AsrimHospitalsUtil
 * @generated
 */
@ProviderType
public interface AsrimHospitalsPersistence
	extends BasePersistence<AsrimHospitals> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AsrimHospitalsUtil} to access the asrim hospitals persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public void cacheResult(java.util.List<AsrimHospitals> asrimHospitalses);
	 ...
	 */
	public java.util.List<AsrimHospitals> findAll();
	 ...
	 */
	public java.util.List<AsrimHospitals> findAll(int start, int end);
	...
	public java.util.List<AsrimHospitals> findAll(
		int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<AsrimHospitals>
			orderByComparator);
