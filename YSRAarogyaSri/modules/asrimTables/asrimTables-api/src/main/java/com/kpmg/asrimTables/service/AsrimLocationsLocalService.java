...
/**
 * Provides the local service interface for AsrimLocations. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AsrimLocationsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AsrimLocationsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.kpmg.asrimTables.service.impl.AsrimLocationsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the asrim locations local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link AsrimLocationsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public AsrimLocations addAsrimLocations(AsrimLocations asrimLocations);
	...
	public AsrimLocations createAsrimLocations(String LOC_ID);
	...
	public AsrimLocations deleteAsrimLocations(AsrimLocations asrimLocations);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public AsrimLocations deleteAsrimLocations(String LOC_ID)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AsrimLocations fetchAsrimLocations(String LOC_ID);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public AsrimLocations getAsrimLocations(String LOC_ID)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<AsrimLocations> getAsrimLocationses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public AsrimLocations updateAsrimLocations(AsrimLocations asrimLocations);
