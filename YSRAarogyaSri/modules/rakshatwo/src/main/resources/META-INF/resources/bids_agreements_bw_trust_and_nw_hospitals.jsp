...
<%@ include file="/rightcontentr.jsp" %>
   ...
   <h3 class="title">Agreements Between Trust And Network Hospitals.</h3>
  <div class="page">
  <table class="table">
    <thead>
    <tr>
    ...
    <tr>
      ...
      Dr.YSR Aarogyasri Health Care Trust Scheme
      </th>
      <td>-</td>
      <td>PERIOD - I</td>
      <td>PERIOD - II</td>
    ...
    <tr>
      <th scope="row" rowspan="2">CMCO</th>
      <td>-</td>
      <td>PERIOD - I</td>
      <td>PERIOD - II</td>
      <td>PERIOD - III</td>
    ...
    <tr>
      <th scope="row" rowspan="2">Journalist</th>
      <td>-</td>
      <td>PERIOD - I</td>
      <td>PERIOD - II</td>
      <td>PERIOD - III</td>
