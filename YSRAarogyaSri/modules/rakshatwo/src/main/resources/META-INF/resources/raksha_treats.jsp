...
<h3 class="bordertitle text-dark">Check Treatment History</h3>
				...
				<div class="accordion" id="accordionExample">
					...
					<div class="accordion-item">
						...
						<div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
							<div class="accordion-body">
								<p>The beneficiaries can also get the details of the amount utilized for the current financial year at any given point of time. The details of the amount utilized can be viewed for both the entire family at a glance as well as individual member wise.</p>
								<p>The beneficiary shall get the below information from the above screen:</p>
								<ul>
									<li>Total amount allocation to him / her for the current financial year.</li>
										<li>Amount utilized on individual family member.</li>
										<li>The balance amount that can be utilized in the current financial year.</li> 
										<li>Case wise details of utilization.</li>
								</ul>
								<p>The provision shall be made available which shall facilitate the beneficiary to check how much amount has been spent on his /her dependent individual case wise. The above tentative screen to have a provision where the beneficiary can select the family member. On selecting the family member, the system shall fetch the below details of that individual:	</p>
								<ul>
									<li>Total amount utilized on that individual in the current financial year</li>
									<li>Case number</li>
									<li>Details of the Procedure (Can we remove it for phase 1)</li>
									<li>Amount spent on each of the procedure</li>
								</ul>
				...
				<br />
				<h5 class="text-center">To access Aarogyasri App, Please scan the QR code.	</h5>
				<div class="row row-cols-2 row-cols-sm-2 row-cols-md-4 qr_code text-center">
					<div class="col">
					  <div class="card shadow-sm">
						<img src="/documents/d/guest/dr-ysr-ahct" class="img-fluid" alt="QR CODE" />
			
						<div class="card-body">
						  <p class="card-text">Aarogyasri</p>
