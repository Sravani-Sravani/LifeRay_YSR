...
/**
 * Provides the local service interface for NewsAndEvents. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see NewsAndEventsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface NewsAndEventsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.kpmg.customtables.service.impl.NewsAndEventsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the news and events local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link NewsAndEventsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public NewsAndEvents addNewsAndEvents(NewsAndEvents newsAndEvents);
	...
	public NewsAndEvents createNewsAndEvents(long newsId);
	...
	public NewsAndEvents deleteNewsAndEvents(long newsId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public NewsAndEvents deleteNewsAndEvents(NewsAndEvents newsAndEvents);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NewsAndEvents fetchNewsAndEvents(long newsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public NewsAndEvents getNewsAndEvents(long newsId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<NewsAndEvents> getNewsAndEventses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public NewsAndEvents updateNewsAndEvents(NewsAndEvents newsAndEvents);
