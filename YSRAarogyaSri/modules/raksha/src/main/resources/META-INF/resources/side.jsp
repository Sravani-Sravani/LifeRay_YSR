...
<li class="mb-1">
	...
	<!-- 							<div class="collapse" id="history-collapse" data-bs-parent="#citizen-collapse">
			...
			<!-- 					<div class="collapse" id="usermanuals-collapse" data-bs-parent="#citizen-collapse">
					...
					<div class="collapse <% if(pageId==559 || pageId==427 || pageId==431 || pageId == 153 || pageId==640){ %> show <% } %>" id="hospital-collapse"> 
					  ...
					  <li class="mb-1">
						...
						<div class="collapse <% if(pageId==559 || pageId==427 || pageId==431 ||pageId==640){ %> show <% } %>" id="hospital-collapse1" data-bs-parent="#hospital-collapse">
						  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
					  ...
					  <li class="mb-1">
						...
						<div class="collapse <% if(pageId==153 ||pageId==627){ %> show <% } %>" id="employees-collapse1" data-bs-parent="#hospital-collapse">
						  <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
							...
							<li><a href="https://ysraarogyasri.ap.gov.in/web/guest/it">IT Support</a></li>
						  </ul>
						</div>
					  </li>
					</ul> 
